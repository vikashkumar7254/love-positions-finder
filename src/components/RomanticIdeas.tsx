    ...
    <section className="px-6 py-12 bg-gradient-to-b from-background to-romantic/5">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8">
          <h2 className="text-3xl md:text-4xl font-extrabold mb-3 bg-gradient-to-r from-romantic to-passionate bg-clip-text text-transparent">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <CardHeader className="text-center pb-4">
              <div className="flex items-center justify-center gap-3 mb-2">
                <div className="w-12 h-12 rounded-full bg-romantic/25 flex items-center justify-center">
                  <currentIdea.icon className="w-6 h-6 text-romantic" />
                </div>
              ...
              <div className="flex items-center justify-center gap-3 flex-wrap">
                <span className={`px-3 py-1 rounded-full text-xs font-medium ${getCategoryColor(currentIdea.category)}`}>
                  {currentIdea.category}
                </span>
                <span className={`px-3 py-1 rounded-full text-xs font-medium ${getDifficultyColor(currentIdea.difficulty)}`}>
                  {currentIdea.difficulty}
                </span>
                <span className="px-3 py-1 rounded-full text-xs font-medium bg-background/60 text-foreground/80 flex items-center gap-1">
          ...
          {/* Quick Ideas Grid */}
          <div className="mt-8">
            <h3 className="text-xl font-semibold text-center mb-4 text-foreground/90">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                <Card key={index} variant="elegant" className="p-4 text-center hover:scale-105 transition-transform cursor-pointer">
